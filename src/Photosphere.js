...
const Photosphere = props => {
  ...
  const pointData = [
    ...
    {name: "3", x: 3, y: 0.1, z: 3, src: "./img/page2/bièvre-à-atony.png", img: [{original: './img/bievre-01.jpg'},{original: './img/bievre-02.jpg'},{original: './img/bievre-03.jpg'},{original: './img/bievre-04.jpg'}], title: `LA BIÈVRE À ANTONY`, text: `Longue de 35 km, la Bièvre, qui prend sa source à Guyancourt, traverse 15 communes. Elle entre 
    ...
    RD 920.`},
    {name: "4", x: -3, y: -0.5, z: -3, src: "./img/page2/lavoirs.png", img: [{original: './img/lavoir-01.jpg'},{original: './img/lavoir-02.jpg'},{original: './img/lavoir-03.jpg'}], title: `LES LAVOIRS`, text: `La Ville mettait à la disposition des habitants des lavoirs pour effectuer leurs « grandes lessives ».
    ...
    et les pantalons.`},
    {name: "5", x: 4, y: -1, z: 0, src: "./img/page2/métiers-de-la-bièvre.png", img: [{original: './img/metiers-bievre-01.jpg'},{original: './img/metiers-bievre-02.jpg'},{original: './img/metiers-bievre-03.jpg'}], title: `LES MÉTIERS DE LA BIÈVRE`, text: `Vers la fin du XVIIe
