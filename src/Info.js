      ...
      <div className="header-page-scroll">
        <div className="text-wrappper info">
          ...
          <span className='info-subtitle'>Horaires d’ouverture :</span> le parc est ouvert de 5 h 30 à 22 h 30, été comme hiver.<br/><br/>
            ...
            <span className='info-subtitle'>Crédits photos :</span><br/><br/>Les représentations iconographiques et photographiques contenues dans ce<br/>site sont utilisées avec l'accord de leurs auteurs : Georges Jabbour, Ville d’Antony. La<br/>reproduction de ces photographies et illustrations est interdite sans autorisation préalable.<br/><br/>
            ...
            L'équipe de Ville d'Antony n'a pas la maîtrise de leur contenu et décline toute responsabilité<br/>quant aux informations qui y sont présentées.<br/><br/>
            ...
            Jean-Philippe RACINE (N° d'entreprise 2277422079 ; 230 Taschereau Est, Rouyn-Noranda,<br/>Québec, J9X3E8 Canada), a réalisé l'intégration et le développement de ce site.<br/><br/>
            <span className='info-subtitle'>CRÉDITS</span><br/><br/>

            Vidéo et Audio :Georges Jabbour (Amaiway Prod), INA, Ville d’Antony<br/>
            Photos : Ville d’Antony, Christophe Portat<br/><br/>

            <span className='info-subtitle'>REMERCIEMENTS</span><br/><br/>

            Métropole du Grand Paris<br/>
            Syndicat Mixte du Bassin Versant de la Bièvre (SMBVB)<br/>
            Delphine Lagrandeur et Marc Jeancourt, Directeurs de l’Azimut pour leur voix<br/>
            Need Radio, Medhi Ferchouli pour la captation sonore des voix et le prêt des studios
          </div>
        </div>
      </div>
    </div>
